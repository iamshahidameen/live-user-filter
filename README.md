...
![Project Screenshot](https://50projects50days.com/img/projects-img/42-live-user-filter.png)

</div>

# Live User Filter

Using 'https://randomuser.me/api?results=80' API, load the random users from the API and show it with the help of async await on API request.
